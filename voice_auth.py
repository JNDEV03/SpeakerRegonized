...
def recognize(file):
    ...
    if min(list(distances.values())) < p.THRESHOLD:
        print("Recognized: ", recognized_user)
    else:
    ...
    json_file_path = "recognition_result.json"
    with open(json_file_path, "w") as json_file:
        json.dump(recognition_result, json_file)
    print("Recognition results saved to:", json_file_path)
